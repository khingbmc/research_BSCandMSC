...
class TestNeural:
    def __init__(self, inputs, hiddens, outputs, w1, w2, num_data):
        ...
        self.beta = 10
        self.sum_error = []
        file = open("../../../present/learning_rate_test/BC/BPNN+MW0/initial_weight/init_weight_1"+".txt", "a")
    ...
    def training(self, dataset, learn_rate, num_iteration, num_output, test):
        ...
        file = open("../../../present/learning_rate_test/BC/BPNN+MW0/network/end_weight_1"+".txt", "a")
        file.write(str(self.network)+"\n\n")
        file.close()
